...
const Todo = ({todo,deleteTodo}) => {
    return (
        <div className='m-2 border border-orange-500 bg-white grid grid-cols-6 p-2 rounded-md'>
            ...
            <div><MdOutlineDownloadDone className='text-2xl text-white bg-green-600 block mx-auto hover:scale-110 duration-100 cursor-pointer'></MdOutlineDownloadDone></div>
        </div>
    );
};
